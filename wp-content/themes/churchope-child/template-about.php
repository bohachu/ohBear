...
<div id="contentarea" class="row clearfix">
   ...
   <div id="about-ohbear-id" class="mobile-hide">
    ...
    <div id="about-ohbear-id-right">
     <div class="about-top"> 
     <img class="about-left" src="<?php echo get_stylesheet_directory_uri(); ?>/images/2-about/ohbear_title.png" alt="">
     <img class="about-right" src="<?php echo get_stylesheet_directory_uri(); ?>/images/2-about/ohbear_pic.png" alt="">
     </div>
     <hr>
   ...
   <div id="about-ohbear-story" class="mobile-hide">
     ...
     <div name="flipgorilla" data-id="23837411469436052" style="width: 900px; height: 600px;"></div><script type="text/javascript" src="http://www.flipgorilla.com/fg.js"></script>
     </div>
   </div>
