	...
	function blog_shortcode($atts, $content = null)
	{
		...
		if ($post_list && $post_list->have_posts()) :
			...
			<?php while ($post_list->have_posts()) : $post_list->the_post(); ?>
	                    <article <?php post_class(' gallery_listing small grid_4 clearfix') ?> id="post-<?php the_ID(); ?>"> 
					<?php if (has_post_thumbnail()): ?>
						<a href="<?php the_permalink() ?>" title="<?php echo the_title(); ?>" class="imgborder clearfix thumb"><?php get_theme_post_thumbnail(get_the_ID(), 'gallery_small'); ?></a>
					<?php endif; ?>
