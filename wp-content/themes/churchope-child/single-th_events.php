...
<div id="contentarea" class="row clearfix">
  <div id="ohbear-events">
    <img class="events-left" src="<?php echo get_stylesheet_directory_uri(); ?>/images/1-index/event_title.png">
    <img class="events-right"  src="<?php echo get_stylesheet_directory_uri(); ?>/images/1-index/event_pic.png" >
    <hr>
    </div>
