						...
						<div class="logo grid_6">
							...
							if (get_option(SHORTNAME . "_logo_txt") || get_option(SHORTNAME . "_logo_custom"))
							{
								...
								if (is_front_page())
								{
									...
									{
										?>
										<a href="<?php echo wpml_get_home_url() ?>"><img src="<?php echo get_option(SHORTNAME . "_logo_custom"); ?>" alt="<?php bloginfo('name'); ?>" data-retina="<?php echo get_option(SHORTNAME . "_logo_custom_retina"); ?>" /><span class="hidden"><?php bloginfo('name'); ?></span></a>
									<?php } ?>
									<?php
									if (is_front_page())
									{
