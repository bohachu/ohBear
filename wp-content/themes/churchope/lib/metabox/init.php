...
function cmb_scripts( $hook ) {
  	if ( $hook == 'post.php' || $hook == 'post-new.php' || $hook == 'page-new.php' || $hook == 'page.php' ) {
		...
		wp_register_script( 'cmb-multidatepicker', get_template_directory_uri() .'/lib/metabox/js/jquery-ui.multidatespicker.min.js' );
...
//		wp_register_script( 'cmb-scripts', CMB_META_BOX_URL . 'js/cmb.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker', 'media-upload', 'thickbox', 'farbtastic' ) );
		...
		wp_enqueue_script( 'cmb-multidatepicker' );
