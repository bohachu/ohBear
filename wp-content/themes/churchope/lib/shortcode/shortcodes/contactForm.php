		...
		<form id="fb-preview">
			...
			<div id="fb-email-settings" class="fb-container" style="float: left;">
				...
				<div class="fb-form-case fb-settings">
					...
					<label fieldid="sendbutton" for="fb-sendbutton" style="margin-top: 14px;"><?php _e('Send button text', 'churchope'); ?></label>
					<input type="text" id="fb-sendbutton" style="background: #FFF !important;" value="">

					<label fieldid="captcha" for="fb-captcha" style="margin-top: 14px;"><?php _e('Use reCaptcha(Public&Private keys must be set)', 'churchope'); ?></label>
					<input type="checkbox" id="fb-captcha" style="background: #FFF !important; float: none" value=""><span style="color: #AAA; padding-left:10px; "><?php _e('Theme Options -> reCaptcha', 'churchope'); ?></span>
				</div>
