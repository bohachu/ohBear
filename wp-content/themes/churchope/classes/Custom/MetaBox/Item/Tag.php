...
class Custom_MetaBox_Item_Tag extends Custom_MetaBox_Item_Default
{
	...
	protected function addFields()
	{
		...
		$this->getMetaTaxInstance()->addSelect( SHORTNAME . Admin_Theme_Item_Slideshow::SLIDER, Admin_Theme_Element_Select_Slider::getSliders(), array('name' => 'Slider', 'std' => '', 'desc'=>'Select a slider for current taxonomy'));
...
//		$this->getMetaTaxInstance()->addSelect( SHORTNAME . '_tax_slider_effect', Admin_Theme_Item_Slideshow::getTaxonomySlideshowEffectList() , array('name' => 'Slideshow effect', 'std' => 'fade', 'desc'=>'Choose slideshow effect for this category'));
		...
		$this->getMetaTaxInstance()->addSelect( SHORTNAME . '_enable_page_header_color', array('enable_page_header_color'=>'Use selected custom color',''=>'Use global'), array('name' => 'Custom page header color', 'std' => ''));
		$this->getMetaTaxInstance()->addColor( SHORTNAME . '_page_header_color', array('name' => 'Choose custom page header color for category:'));
