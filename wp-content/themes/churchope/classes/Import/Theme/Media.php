...
class Import_Theme_Media implements Import_Theme_Item
{
	...
	public function import()
	{
		...
		$default_images = array('th_default1.jpg', // 0 draw-closer-to-jesus-christ
			...
			'revolution.png', // 6 revolution
			'custom_header.png', //7 custom header 
		);
			...
			if ($post && isset($post->post_name))
			{
				...
				switch ($post->post_name)
				{
					...
					case 'slider-revolution':
						set_post_thumbnail(get_the_ID(), $attach_ids[6]);
						break;
					case 'unique-header-background-for-each-page':
						set_post_thumbnail(get_the_ID(), $attach_ids[7]);
						break;
					default:
						break;
				}
