...
class Import_Theme_Widgets implements Import_Theme_Item
{
	...
	public function import()
	{
		...
		$churchope_social_links[2] = array(
                    "hide_icon" => "", "title" => "Follow us",                    
                    "rss_feed"            => "",            "rss_feed_title" => "", 
                    "facebook_account"    => "themoholics", "facebook_account_title"    => "Facebook",                     
                    "twitter_account"     => "themoholics", "twitter_account_title"     => "Twitter", 
                    "dribble_account"     => "themoholics", "dribble_account_title"     => "Dribbble", 
                    "flicker_account"     => "",            "flicker_account_title"     => "", 
                    "vimeo_account"       => "",            "vimeo_account_title"       => "", 
                    "email_to"            => "themoholics", "email_to_title"            => "Email", 
                    "youtube_account"     => "",            "youtube_account_title"     => "", 
                    "pinterest_account"   => "",            "pinterest_account_title"   => "", 
                    "google_plus_account" => "themoholics", "google_plus_account_title" => "Google Plus",                 
                    "linked_in_account"   => "",            "linked_in_account_title"   => "",
                    
                    "picasa_account"      => "",            "picasa_account_title"      => "Picasa",        // Picasa
                    "digg_account"        => "",            "digg_account_title"        => "Digg",          // Digg
                    "plurk_account"       => "",            "plurk_account_title"       => "Plurk",         // Plurk
                    "tripadvisor_account" => "",            "tripadvisor_account_title" => "Tripadvisor",   // Tripadvisor
                    "yahoo_account"       => "",            "yahoo_account_title"       => "Yahoo",         // Yahoo
                    "delicious_account"   => "",            "delicious_account_title"   => "Delicious",     // Delicious
                    "devianart_account"   => "",            "devianart_account_title"   => "Devianart",     // Devianart
                    "tumblr_account"      => "",            "tumblr_account_title"      => "Tumblr",        // Tumblr
                    "skype_account"       => "",            "skype_account_title"       => "Skype",         // Skype
                    "apple_account"       => "",            "apple_account_title"       => "Apple",         // Apple
                    "aim_account"         => "",            "aim_account_title"         => "Aim",           // Aim
                    "paypal_account"      => "",            "paypal_account_title"      => "Paypal",        // Paypal
                    "blogger_account"     => "",            "blogger_account_title"     => "Blogger",       // Blogger
                    "behance_account"     => "",            "behance_account_title"     => "Behance",       // Behance
                    "myspace_account"     => "",            "myspace_account_title"     => "Myspace",       // Myspace
                    "stumble_account"     => "",            "stumble_account_title"     => "Stumble",       // Stumble
                    "forrst_account"      => "",            "forrst_account_title"      => "Forrst",        // Forrst
                    "imdb_account"        => "",            "imdb_account_title"        => "Imdb",          // Imdb
                    "instagram_account"   => "",            "instagram_account_title"   => "Instagram",     // Instagram
                );
