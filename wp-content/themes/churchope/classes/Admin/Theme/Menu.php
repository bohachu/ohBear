...
class Admin_Theme_Menu
{
	...
	private function setMenuPageList($menu_slug)
	{
		$this->menu_page_list = array(
			...
			new Admin_Theme_Item_Sermons($menu_slug),
	...
	{
		wp_enqueue_script('th-colorpicker', get_template_directory_uri() . '/backend/js/mColorPicker/javascripts/mColorPicker.js', array('jquery'), null);
		wp_enqueue_script('th-uniform', get_template_directory_uri() . '/backend/js/uniform/jquery.uniform.min.js', array('jquery'), null);
		wp_enqueue_script('th-ibutton', get_template_directory_uri() . '/backend/js/switcher/lib/jquery.ibutton.min.js', array('jquery'), null);
		wp_enqueue_script('th-qtip', get_template_directory_uri() . '/backend/js/qtip/jquery.qtip.pack.js', array('jquery'), null);
		wp_enqueue_script('th-modernizr', get_template_directory_uri() . '//js/modernizr.min.js', array('jquery'), null);
	...
	public function getJSCode()
	{
		...
		$script = '<script type="text/javascript" charset="utf-8">
						jQuery(function(){
							jQuery("input:text, input:file,  textarea, select, button").uniform({selectAutoWidth: false });
						});
