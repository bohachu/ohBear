...
class Admin_Theme_Element_Colorchooser extends Admin_Theme_Menu_Element
{
	...
	public function render()
	{
		...
		?>
		<input style="width:100px;clear:both" name="<?php echo $this->id; ?>" id="<?php echo $this->id; ?>" type="color" data-hex="true" value="<?php if (get_option($this->id) != "")
		{
			echo get_option($this->id);
		}
		else
		{
			echo $this->std;
