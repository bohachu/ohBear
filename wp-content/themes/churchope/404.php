...
<div id="contentarea" class="row clearfix">
	...
	<div class="main-content <?php echo (get_option(SHORTNAME . '_post_listing_layout') == 'none') ? 'grid_12' : 'grid_8'; ?>">    
		<article  class="clearfix grid_8">
			...
			<p><?php _e('Try refining your search, or use the navigation above to locate the post.', 'churchope'); ?></p>
                        <p><a href="<?php echo get_home_url() ?>" class="churchope_button"><?php _e('Back to home', 'churchope'); ?></a></p>
		</article>
	</div>
