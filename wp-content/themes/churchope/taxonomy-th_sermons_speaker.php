...
$post_sidebar = (get_tax_meta($term->term_id, SHORTNAME . '_post_listing_sidebar', true)) ? get_tax_meta($term->term_id, SHORTNAME . '_post_listing_sidebar', true) : get_option(SHORTNAME . '_sermons_listing_sidebar');
?>
