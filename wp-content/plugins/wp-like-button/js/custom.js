...
function cfb() {
    ...
    var data = '<div class="fb-like" data-href="'+url+'" data-width="' + width + '" data-layout="' + layout + '" data-action="' + action + '" data-show-faces="'+faces+'" data-share="'+share+'" data-colorscheme="'+color+'"  ></div>';
