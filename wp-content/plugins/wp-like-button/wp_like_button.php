...
function fblb_init() {
    ...
    $data = '';
    $data_array = array();
    if($myrows[0]->display & 1){$display[1] = 'checked';};
    if($myrows[0]->display & 2){$display[2] = 'checked';};
    if($myrows[0]->display & 4){$display[4] = 'checked';};
    if($myrows[0]->display & 8){$display[8] = 'checked';};
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="fblb_form-group">
                                                        ...
                                                        <input type="checkbox" id="display8" onchange="if(this.checked){jQuery('.fblb_exclude').show(200)} else {jQuery('.fblb_exclude').hide(200)}" name="display[]" <?php echo @$display['8']; ?> value="8" class="fblb_form-control fblb_check" style="float:left"><label for="display8">Exclude following pages and posts</label>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
...
For instance, add following code to header or footer.php to display like button
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input onblur="if(!isNumeric(this.value)){alert('Only digits allowed'); this.focus();}" type="text" id="width" placeholder="" style="width:93%; float:left" name="width" value="<?php echo $myrows[0]->width; ?>" class="fblb_form-control">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="fblb_form-group" id="wpfblikebutton_faces" style="text-align: center;">
                                                        <input onchange=" cfb()" <?php if($myrows[0]->faces == 1){echo 'checked';} ?> type="checkbox" style="float:left" value="1" name="faces" id="faces"><label style="float:left; line-height: 10px; padding-left: 10px;" for="faces">Show Friends' Faces</label>
                                                    </div>
                                                </td>
                                                <td></td>
                                                <td> 
                                                    <div class="fblb_form-group" style="text-align: center">
                                                        <input onchange=" cfb()" <?php if($myrows[0]->share == 1){echo 'checked';} ?>  type="checkbox" style="float:left" value="1" name="share" id="share"><label style="float:left; line-height: 10px; padding-left: 10px;" for="share">Include Share Button</label>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
