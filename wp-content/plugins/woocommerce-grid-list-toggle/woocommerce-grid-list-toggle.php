			...
			function gridlist_toggle_button() {
				?>
					<nav class="gridlist-toggle">
						...
						<a href="#" id="grid" title="<?php _e('Grid view', 'woocommerce-grid-list-toggle'); ?>"> <em><?php _e( 'Grid view', 'woocommerce-grid-list-toggle' ); ?></em></a><a href="#" id="list" title="<?php _e('List view', 'woocommerce-grid-list-toggle'); ?>"> <em><?php _e( 'List view', 'woocommerce-grid-list-toggle' ); ?></em></a>
					</nav>
				<?php
			}
